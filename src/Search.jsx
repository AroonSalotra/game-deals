...
const Search = () => {
    ...
    const [url, setUrl] = useState(`https://www.cheapshark.com/api/1.0/deals?storeID=1&onSale=true&upperPrice=20&metacritic=80`)
            ...
            <div className={display}>
                ...
                {data ? data.map(({ title, metacriticScore, thumb, gameID }) => {
                    return <div key={gameID}>
                        ...
                        <p className="game-score">{metacriticScore}</p>
                    </div>
                })
                    : null}
            </div>
